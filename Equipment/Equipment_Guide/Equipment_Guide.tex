...
\section{Software}
Channel lists are built using NI-MAX and fed into 32-bit NI LabVIEW as a task using DAQ-mX. Note that in the current configuration, the laptop must also have a 32-bit operating system on it.
