...
\renewcommand{\bibname}{Equipment_Manual}
...
The GoPro cameras and DVR split long videos into multiple files. If you need to combine multiple .mp4 videos into one file, you can use a tool such as MP4Box or Avidemux. Multiple video files can also result from the DVR if a video channel loses signal temporarily. If this is the case, be sure to add blank video to pad any time that passed while the video channel signal was lost.
