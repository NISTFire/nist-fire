...
\end{figure}
Based on the monitor position (arrow at the doorway in Fig.~\ref{fig:Gas_Cooling_Instrumentation_Dimensions2}), thermocouple arrays A1 and A2 had more direct impact from the suppression agent compared to thermocouple array A3. Figure~\ref{fig:Burn_Building_Test_18b}, which shows the distribution of the water within the burn building from a spray density test for a straight stream with CAFS at the mid position, highlights the positions of the thermocouple trees.
...
\begin{figure}[!ht]
	...
	\caption{CAFS vs Water Gas Cooling Comparison for Thermocouple Tree A1}
	\label{fig:CAFS_Water_A1_all}
\end{figure}

\begin{figure}[!ht]
	\includegraphics[width=.8\columnwidth]{../Figures/Gas_Cooling/Combined_A2_scatter}
	\caption{CAFS vs Water Gas Cooling Comparison for Thermocouple Tree A2}
...
\begin{figure}[!ht]
	...
	\caption{CAFS vs Water Gas Cooling Comparison for Thermocouple Tree A3}
