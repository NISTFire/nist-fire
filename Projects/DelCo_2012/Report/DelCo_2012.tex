...
\begin{figure}[ht!]
	...
	\caption{Time Series of Thermocouple Data from 3 Arrays in Gas Cooling Room with Water as the Suppression Agent. Shown are Tests 2, 3, and 4 from Table~\ref{tab:Gas_Cooling_Descriptions}}
...
\begin{figure}[ht!]
	...
	\caption{Time Series of Thermocouple Data from 3 Arrays in Gas Cooling Room with CAF as the Suppression Agent. Shown are Tests 52, 53, and 54 from Table~\ref{tab:Gas_Cooling_Descriptions}}
