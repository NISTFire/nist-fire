...
\begin{figure}[!ht]
	...
	\caption{Schematic Indicating Thermcouple Arrays A1 and A2 for Fire Suppression Experiments}
...
\begin{figure}[!ht]
	...
	\caption{Time Series of Thermcouple Data from Array TC A2 from Single Story CAF~1 Fire Suppression Test}
	\label{fig:caf1_tca2}
\end{figure}

\begin{figure}[!ht]
	\includegraphics[width=.85\columnwidth]{../Figures/Script_Figures/FSW_Test_2_092812_TC_A2}
	\caption{Time Series of Thermcouple Data from Array TC A2 from Single Story Water~1 Fire Suppression Test}
	\label{fig:water1_tca2}
\end{figure}

Similar to the gas cooling tests, the impact of water and CAF during fire suppression can be analyzed by comparing the temperature differences during the suppression interval at the two the thermocouple arrays in the fire room. Figures~\ref{fig:fs_hall_a1} and \ref{fig:fs_door_a1} show the temperature difference comparison at thermocouple array A1 for CAF and water after the hallway nozzle was activated and then the doorway nozzle was actived, respectively. 
...
\chapter{Fire Suppression Data}
\label{app:fire_suppression}

\begin{figure}[ht]
\includegraphics[width=.7\columnwidth]{../Figures/Script_Figures/FSE_Test_1_092812_TC_A1}
\includegraphics[width=.7\columnwidth]{../Figures/Script_Figures/FSE_Test_1_092812_TC_A2}
\includegraphics[width=.7\columnwidth]{../Figures/Script_Figures/FSE_Test_1_092812_TC_A3}
