...
\begin{figure}[ht!]
	...
	\caption{Time series of several gas cooling events in a continuous test}
...
\begin{figure}[ht!]
	\includegraphics[width=.45\columnwidth]{../Figures/Gas_Cooling/GCSeries12_TC_A1}
	\includegraphics[width=.45\columnwidth]{../Figures/Gas_Cooling/GCSeries12_TC_A2}
	\includegraphics[width=.45\columnwidth]{../Figures/Gas_Cooling/GCSeries12_TC_A3}
	\caption{Time series of several gas cooling events in a continuous test}
	\label{fig:gas_cooling_sub1}
\end{figure}

\begin{figure}[ht!]
	\includegraphics[width=.45\columnwidth]{../Figures/Gas_Cooling/GCSeries52_TC_A1}
	\includegraphics[width=.45\columnwidth]{../Figures/Gas_Cooling/GCSeries52_TC_A2}
	\includegraphics[width=.45\columnwidth]{../Figures/Gas_Cooling/GCSeries52_TC_A3}
	\caption{Time series of several gas cooling events in a continuous test}
