...
Based on the results of the study, the fire fighting agents, commonly referred to as Class A foams, were superior to water in cooling and penetrating the fuels, mass retention and ignition inhibition.  All of these features enable the agents, when applied in the form of foam, to provide enhanced radiation exposure protection to a structure relative to plain water.  The foams enhance the water by keeping the water in place on vertical surfaces such as walls and the reduced interfacial surface tension allows the water to penetrate absorbent fuels.  These enhancements also make the agents valuable tools for mop-up. Many of the experiments conducted during this study: specific heat, drop size, contact angle, wood crib suppression, smoke generation and Class D fire suppression yielded similar results for both Class A foams and plain water.
