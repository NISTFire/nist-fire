...
Table~\ref{tab:Test_Results_2} provides the impact of suppression for the water and CAFs tests conducted in the two story structure. The table provides change in temperature 0.3~m (1~ft) below the ceiling and 0.3~m (1~ft) above the floor as well as change in heat flux 1~m (3~ft) above the floor on the 1st floor level in front of the stairway door. These values reported in the table are immediately before and after the application period to assess the application agent, stream, and location on interior conditions.
