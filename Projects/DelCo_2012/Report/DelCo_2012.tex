...
Agents designed primarily for Class A (ordinary combustible) fires have been used most extensively in conjunction with wildland or wildland urban interface fires. These agents are said to be more effective than plain water while being environmentally safe. In some cases, they are also claimed to reduce the quantity and toxicity of smoke. 

So the question is, does CAF provide improved gas cooling when compared to plan water? 
