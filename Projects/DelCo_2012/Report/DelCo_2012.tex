...
\midrule
 ...
 3 & CAF~2    &  7/8'' Solid Stream &  120~gpm/60~cfm   & Furniture      & Door            \\
 4 & Water~2  &  7/8'' Solid Stream &  120~gpm    		& Furniture      & Door            \\
...
\midrule
 ...
 41c & CAF~9b    &  7/8'' Solid Stream  &  120~gpm		    & Furniture + Pallet  & Basement Doors, 1st Floor Door \\
\bottomrule[1.25pt]
\end{tabular}\par
\end{table}
...
In each gas cooling experiment, the same mass flow rate of water was used for both the plain water stream and the CAF stream. Typically the volumetric flow rate of water was 7.57~L/s (120~gpm). The density of water is 1000~kg/m$^3$ (8.3~lb/gal), therefore the mass flow rate was 7.57~kg/s (16.7~lb/s). The average time of flow was 15~s, therefore a total of 114~kg (251~lb) of water was introduced into each gas cooling experiment. When a CAF stream was used it contained 0.3\% foam concentration by volume, check density of foam concentrate   point being mostly water.  Also calc the mass of air in the stream.
...
Thank you to Chief Scott Goldstein and former Chief Steven Lohr of the Montgomery County (MD) Department of Fire and Rescue Service for their support of this study.  Special appreciation goes to the MCFRS staff that participated in the experiments:    Alan Butsch, Daniel Hudson,  Michael Johns, Steven Neubauer, Sean Regan, Chris Reilly, Bryan Rojtas, Ralph “Dewey” Thomas,  and Douglas Wallace.
