...
\subsection{Iowa State Univeristy Fire Flow Formula (1963)}
...
\subsection{National Fire Academy (1884)}
...
The fire rooms in these experiments ranged in floor area from approximately 27~$m^2$ (291~$ft^2$) to 51.4~$m^2$ (553~$ft^2$). Applying the NFA formula based on floor area yields an required flowrate for the single story fire room of 369~Lpm (97~gpm). The required flowrate for the fire room in the lower level of the two story would be approximately 700~Lpm (184~gpm).
