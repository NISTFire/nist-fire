...
All of the fire conditions generated during these experiments were ventilation limited or ventilation controlled fires. In other words if more oxygen was supplied to the fuel gases available in the fire compartment and more products of combustion were exhausted from the fire compartment, the heat release rate of the fire would have increased. There are simple formulas which may provide some insight here, although for full disclosure these simple algorithms have not been validated with the geometry that we used in these experiments.

If we have a single open doorway to a residential scale room, which is approximately 0.9~m (3 ft) wide and 2.1~m (6.9 ft) high, the minimum heat release rate needed to flashover the room would be about 2 MW and the amount of heat release rate that the doorway could support assuming complete combustion of the oxygen that would flow through the doorway opening via natural convection would be approximately 4 MW.  If we double the width of the open doorway (the doorway to the lower level of the two story structure)  Then the heat release rate that could be generated inside the compartment, this does not account for flames burning outside of the compartment, would be approximately 8 MW.          




The flowrate used for these experiments were sufficient to quickly cool the hot gas layer and suppress each of the fires.  
