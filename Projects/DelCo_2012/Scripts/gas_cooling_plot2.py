...
sensor_groups = [['TC_A1_'],['TC_A2_'],['TC_A3_']]
...
for entry in range(0,len(info)):
	if info['Replicates'][entry] == 0:
		...
		del_water = concatenate([del_TC_1_h2o, del_TC_2_h2o, del_TC_3_h2o], axis=1)
		#del_water = del_TC_3_h2o
		del_water = del_water.reshape(-1)
		del_cafs  = concatenate([del_TC_1_cafs, del_TC_2_cafs, del_TC_3_cafs], axis=1)
