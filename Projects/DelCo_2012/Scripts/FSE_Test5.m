...
exp_data_read = importdata([datadir,'FSE_Test_5_093912.csv']); % reads in file into text and data structure
...
Num_TC_arrays = 4;
TC_per_array = 8;
TC_array_names = {'FSE5_Eastside_Array' 'FSE5_Westside_Array' 'FSE5_Hallway_Array' 'FSE5_Doorway_Array'};
TC_array_names_suppression = {'Suppression_FSE5_Eastside_Array' 'Suppression_FSE5_Westside_Array' 'Suppression_FSE5_Hallway_Array' 'Suppression_FSE5_Doorway_Array'};
...
for j=1:Num_TC_arrays-2
    ...
    line([214;214],[0;1100],'Color','k','LineWidth',1)
    text(214,1180,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(234,1180,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(252,1180,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(273,1180,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
...
for j=1:Num_TC_arrays-2
    ...
    line([214;214],[0;1100],'Color','k','LineWidth',1)
    text(214,1180,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(230,1180,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(248,1180,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(269,1180,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(284,1180,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    xlabel('Time (s)')
    ylabel('Temperature ( \circ C)')
    axis([200 350 0 1000])
    legend(TC_array(j,:),'Location','NorthEastOutside')
...
line([284;284],[0;1100],'Color','k','LineWidth',1)
line([214;214],[0;1100],'Color','k','LineWidth',1)
text(214,120,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(230,120,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(248,120,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(269,120,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(284,120,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
ylabel('Heat Flux (kW/m^2)')
axis([200 350 0 100])
legend('Eastside Heat Flux 0.15m','Eastside Rad 0.15m','Location','NorthEastOutside')
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_5_Heat_Flux_Eastside'])
hold off
...
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_5_Heat_Flux_Westside'])
hold off
...
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_5_Heat_Flux_Hallway'])
hold off
...
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_5_Heat_Flux_Near_Fire_Room'])
hold off
...
line([214;214],[-5;5],'Color','k','LineWidth',1)
text(214,7,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
...
print(gcf,'-dpdf',[plotdirvelocity,'FSE_Test_5_Hallway_Velocity'])
hold off
...
line([214;214],[-5;10],'Color','k','LineWidth',1)
text(214,13,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
...
print(gcf,'-dpdf',[plotdirvelocity,'FSE_Test_5_Doorway_Velocity'])
hold off