...
exp_data_read = importdata([datadir,'CAFS_DelCo_FSW_t2master.csv']); % reads in file into text and data structure
...
Num_TC_arrays = 4;
TC_per_array = 8;
TC_array_names = {'FSW2 Test 14 Eastside Array' 'FSW2 Test 14 Westside Array' 'FSW2 Test 14 Hallway Array' 'FSW2 Test 14 Doorway Array'};
TC_array_names_suppression = {'Suppression FSW2 Test 14 Eastside Array' 'Suppression FSW2 Test 14 Westside Array' 'Suppression FSW2 Test 14 Hallway Array' 'Suppression FSW2 Test 14 Doorway Array'};
...
for j=1:Num_TC_arrays-2
    ...
    line([435;435],[0;1100],'Color','k','LineWidth',1)
    line([495;495],[0;1100],'Color','k','LineWidth',1)
    line([510;510],[0;1100],'Color','k','LineWidth',1)
    line([570;570],[0;1100],'Color','k','LineWidth',1)
    line([315;315],[0;1100],'Color','k','LineWidth',1)
    text(325,1275,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(445,1275,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(505,1275,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(520,1275,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(580,1275,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    xlabel('Time (s)')
...
for j=1:Num_TC_arrays-2
 ...
 line([435;435],[0;1100],'Color','k','LineWidth',1)
    ...
    line([570;570],[0;1100],'Color','k','LineWidth',1)
    line([315;315],[0;1100],'Color','k','LineWidth',1)
    text(315,1275,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(435,1275,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(495,1275,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(510,1275,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(570,1275,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    xlabel('Time (s)')
    ylabel('Temperature ( \circ C)')
    axis([200 600 0 1000])
    legend_handle = legend(TC_array(j,:),'Location','NorthEastOutside');
...
plot(exp_data_reduced(:,1),heat_flux_reduced(:,2),'-+','Color',red) % RAD1
 line([435;435],[0;1100],'Color','k','LineWidth',1)
    ...
    line([570;570],[0;1100],'Color','k','LineWidth',1)
    line([315;315],[0;1100],'Color','k','LineWidth',1)
    text(315,127,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(435,127,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(495,127,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(510,127,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(570,127,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSW Test 14 Heat Flux Eastside'])
hold off
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSW Test 14 Heat Flux Westside'])
hold off
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSW Test 14 Heat Flux Hallway'])
hold off
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSW Test 14 Heat Flux Near Fire Room'])
hold off
...
plot(exp_data_reduced(:,1),velocity_reduced(:,7),'-d','Color',brown)
 line([435;435],[-5;1100],'Color','k','LineWidth',1)
    line([495;495],[-5;1100],'Color','k','LineWidth',1)
    line([510;510],[-5;1100],'Color','k','LineWidth',1)
    line([570;570],[-5;1100],'Color','k','LineWidth',1)
    line([315;315],[-5;1100],'Color','k','LineWidth',1)
    text(315,7.75,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(435,7.75,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(495,7.75,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(510,7.75,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(570,7.75,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 600 -5 5])
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirvelocity,'FSW Test 14 Hallway Velocity'])
hold off
...
plot(exp_data_reduced(:,1),velocity_reduced(:,14),'-d','Color',brown)
 line([435;435],[-5;1100],'Color','k','LineWidth',1)
    ...
    line([570;570],[-5;1100],'Color','k','LineWidth',1)
    line([315;315],[-5;1100],'Color','k','LineWidth',1)
    text(315,14,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(435,14,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(495,14,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(510,14,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(570,14,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 600 -5 10])
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirvelocity,'FSW Test 14 Doorway Velocity'])
hold off