...
Num_TC_arrays = 4;
TC_per_array = 8;
TC_array_names = {'FSE8_Eastside_Array' 'FSE8_Westside_Array' 'FSE8_Hallway_Array' 'FSE8_Doorway_Array'};
TC_array_names_suppression = {'Suppression_FSE8_Eastside_Array' 'Suppression_FSE8_Westside_Array' 'Suppression_FSE8_Hallway_Array' 'Suppression_FSE8_Doorway_Array'};
...
for j=1:Num_TC_arrays-2
    ...
    line([240;240],[0;1100],'Color','k','LineWidth',1)
    line([260;260],[0;1100],'Color','k','LineWidth',1)
    line([275;275],[0;1100],'Color','k','LineWidth',1)
    line([290;290],[0;1100],'Color','k','LineWidth',1)
    line([180;180],[0;1100],'Color','k','LineWidth',1)
    text(184,1180,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(244,1180,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(264,1180,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(279,1180,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(294,1180,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    xlabel('Time (s)')
...
for j=1:Num_TC_arrays-2
    ...
    line([290;290],[0;1100],'Color','k','LineWidth',1)
    line([180;180],[0;1100],'Color','k','LineWidth',1)
    text(180,1180,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(240,1180,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(260,1180,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(275,1180,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(290,1180,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    xlabel('Time (s)')
    ylabel('Temperature ( \circ C)')
    axis([150 350 0 1000])
    legend(TC_array(j,:),'Location','NorthEastOutside')
...
plot(exp_data_reduced(:,1),heat_flux_reduced(:,2),'-+','Color',red) % RAD1
  line([240;240],[0;1100],'Color','k','LineWidth',1)
    ...
    line([290;290],[0;1100],'Color','k','LineWidth',1)
    line([180;180],[0;1100],'Color','k','LineWidth',1)
    text(180,210,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(240,210,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(260,210,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(275,210,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(290,210,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
ylabel('Heat Flux (kW/m^2)')
axis([150 350 0 175])
legend('Eastside Heat Flux 0.15m','Eastside Rad 0.15m','Location','NorthEastOutside')
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_8_Heat_Flux_Eastside'])
hold off
...
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_8_Heat_Flux_Westside'])
hold off
...
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_8_Heat_Flux_Hallway'])
hold off
...
print(gcf,'-dpdf',[plotdirheatflux,'FSE_Test_8_Heat_Flux_Near_Fire_Room'])
hold off
...
plot(exp_data_reduced(:,1),velocity_reduced(:,7),'-d','Color',brown)
  line([240;240],[-5;5],'Color','k','LineWidth',1)
    line([260;260],[-5;5],'Color','k','LineWidth',1)
    line([275;275],[-5;5],'Color','k','LineWidth',1)
    line([290;290],[-5;5],'Color','k','LineWidth',1)
    line([180;180],[-5;5],'Color','k','LineWidth',1)
    text(180,7,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(240,7,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(260,7,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(275,7,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(290,7,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([150 350 -5 5])
legend(BDP_array,'Location','NorthEastOutside')
print(gcf,'-dpdf',[plotdirvelocity,'FSE_Test_8_Hallway_Velocity'])
hold off
...
plot(exp_data_reduced(:,1),velocity_reduced(:,14),'-d','Color',brown)
  line([240;240],[-5;10],'Color','k','LineWidth',1)
    line([260;260],[-5;10],'Color','k','LineWidth',1)
    line([275;275],[-5;10],'Color','k','LineWidth',1)
    line([290;290],[-5;10],'Color','k','LineWidth',1)
    line([180;180],[-5;10],'Color','k','LineWidth',1)
    text(180,13,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(240,13,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(260,13,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(275,13,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(290,13,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([150 350 -5 10])
legend(BDP_array2,'Location','NorthEastOutside')
print(gcf,'-dpdf',[plotdirvelocity,'FSE_Test_8_Doorway_Velocity'])
hold off