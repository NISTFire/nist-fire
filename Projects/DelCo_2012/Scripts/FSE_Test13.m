...
exp_data_read = importdata([datadir,'CAFS_DelCo_FSE_t2master.csv']); % reads in file into text and data structure
...
Num_TC_arrays = 4;
TC_per_array = 8;
TC_array_names = {'FSE2 Test 13 Eastside Array' 'FSE2 Test 13 Westside Array' 'FSE2 Test 13 Hallway Array' 'FSE2 Test 13 Doorway Array'};
TC_array_names_suppression = {'Suppression FSE2 Test 13 Eastside Array' 'Suppression FSE2 Test 13 Westside Array' 'Suppression FSE2 Test 13 Hallway Array' 'Suppression FSE2 Test 13 Doorway Array'};
...
for j=1:Num_TC_arrays-2
    ...
    line([390;390],[0;1100],'Color','k','LineWidth',1)
    line([406;406],[0;1100],'Color','k','LineWidth',1)
    line([466;466],[0;1100],'Color','k','LineWidth',1)
    line([225;225],[0;1100],'Color','k','LineWidth',1)
    text(235,1275,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(340,1275,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(400,1275,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(416,1275,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(476,1275,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    xlabel('Time (s)')
...
for j=1:Num_TC_arrays-2
    ...
    line([466;466],[0;1100],'Color','k','LineWidth',1)
    line([225;225],[0;1100],'Color','k','LineWidth',1)
    text(225,1275,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(330,1275,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(390,1275,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(406,1275,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(466,1275,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    xlabel('Time (s)')
    ylabel('Temperature ( \circ C)')
    axis([200 500 0 1000])
    legend_handle = legend(TC_array(j,:),'Location','NorthEastOutside');
...
plot(exp_data_reduced(:,1),heat_flux_reduced(:,2),'-+','Color',red) % RAD1
    ...
    line([466;466],[0;1100],'Color','k','LineWidth',1)
    line([225;225],[0;1100],'Color','k','LineWidth',1)
    text(225,225,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(330,225,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(390,225,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(406,225,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(466,225,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSE Test 13 Heat Flux Eastside'])
hold off
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSE Test 13 Heat Flux Westside'])
hold off
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSE Test 13 Heat Flux Hallway'])
hold off
...
plot(exp_data_reduced(:,1),heat_flux_reduced(:,8),'-+','Color',red) % RAD1
    ...
    line([466;466],[0;1100],'Color','k','LineWidth',1)
    line([225;225],[0;1100],'Color','k','LineWidth',1)
    text(225,450,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(330,450,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(390,450,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(406,450,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(466,450,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
ylabel('Heat Flux (kW/m^2)')
axis([200 500 0 350])
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirheatflux,'FSE Test 13 Heat Flux Near Fire Room'])
hold off
...
plot(exp_data_reduced(:,1),velocity_reduced(:,7),'-d','Color',brown)
    line([330;330],[-5;1100],'Color','k','LineWidth',1)
    line([390;390],[-5;1100],'Color','k','LineWidth',1)
    line([406;406],[-5;1100],'Color','k','LineWidth',1)
    line([466;466],[-5;1100],'Color','k','LineWidth',1)
    line([225;225],[-5;1100],'Color','k','LineWidth',1)
    text(225,7.75,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(330,7.75,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(390,7.75,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(406,7.75,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(466,7.75,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 500 -5 5])
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirvelocity,'FSE Test 13 Hallway Velocity'])
hold off
...
plot(exp_data_reduced(:,1),velocity_reduced(:,14),'-d','Color',brown)
    ...
    line([466;466],[-5;1100],'Color','k','LineWidth',1)
    line([225;225],[-5;1100],'Color','k','LineWidth',1)
    text(225,14,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(330,14,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(390,14,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(406,14,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
    text(466,14,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 500 -5 10])
...
set(gcf,'PaperSize',[Paper_Width_Factor Paper_Height]);
set(gcf,'PaperPosition',[0 0 Paper_Width*1.5 Paper_Height]);
print(gcf,'-dpdf',[plotdirvelocity,'FSE Test 13 Doorway Velocity'])
hold off