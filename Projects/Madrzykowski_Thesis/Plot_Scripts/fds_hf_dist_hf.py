...
data0D  = pd.read_csv(data_dir + 'NG_80kW_GBWall_0D_RI=10_devc.csv',header=1)
datap5D = pd.read_csv(data_dir + 'NG_80kW_GBWall_p5D_RI=10_devc.csv',header=1)
data1D  = pd.read_csv(data_dir + 'NG_80kW_GBWall_1D_RI=10_devc.csv',header=1)
data2D  = pd.read_csv(data_dir + 'NG_80kW_GBWall_2D_RI=10_devc.csv',header=1)


fig = figure()
for i in range(0,len(hf_channels),5):
