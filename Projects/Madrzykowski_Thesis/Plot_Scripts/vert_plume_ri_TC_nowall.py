...
fds_slice_10_022 = fds_10_022.iloc[:,13:25].mean()

fds_slice_20 = fds_20.iloc[:,13:25].mean()
fds_slice_20_022 = fds_20_022.iloc[:,13:25].mean()
...
savefig(plot_dir + test_name + '_RF_RI5_TC.pdf',format='pdf')
close()

fig = figure()
plot(fds_05['Time'],fds_05['GHF1'],color='purple',marker = 'd',markevery=25,label = 'FDS RF = 0.20 (Default)')
plot(fds_05_022['Time'],fds_05_022['GHF1'],color='red',marker='x',markevery=25,label = 'FDS RF = 0.22')
plot(fds_05_025['Time'],fds_05_025['GHF1'],color='blue',marker='o',markevery=25,label = 'FDS RF = 0.25')
plot(fds_05_030['Time'],fds_05_030['GHF1'],color='green',marker='^',markevery=25,label = 'FDS RF = 0.30')
...
savefig(plot_dir + test_name + '_HF_RI5_TC.pdf',format='pdf')
close()
...
axis([150, 1000, 0, 1.3 ])
legend(numpoints=1,loc='upper right',fontsize=16 )
savefig(plot_dir + test_name + '_RI_TC.pdf',format='pdf')
close()

fig = figure()
plot(fds_05['Time'],fds_05['GHF1'],color='red',marker='x',markevery=25,label = 'FDS 05')
plot(fds_10['Time'],fds_10['GHF1'],color='blue',marker='o',markevery=25,label = 'FDS 10')
plot(fds_20['Time'],fds_20['GHF1'],color='green',marker='^',markevery=25,label = 'FDS 20')
plot(data['Time (s)'], data['Average HF'], 'k', marker='s', markevery=25, label='Experiment')
xlabel('Time (s)', fontsize=20)
ylabel('Heat Flux (kW/m$^2$)', fontsize=20)
xticks(fontsize=16)
...
axis([0, 225, 0, 3 ])
legend(numpoints=1,loc='lower right',fontsize=16 )
savefig(plot_dir + test_name + '_HF_RI_TC.pdf',format='pdf')
close()
...
axis([150, 1000, 0, 1.3 ])
legend(numpoints=1,loc='upper right',fontsize=16 )
savefig(plot_dir + test_name + '_RF22_RI_TC.pdf',format='pdf')
close()
...
axis([0, 225, 0, 3 ])
legend(numpoints=1,loc='lower right',fontsize=16 )
savefig(plot_dir + test_name + '_HF_RF22_RI_TC.pdf',format='pdf')
close()
