...
plot_dir = '../Figures/'
test_name = 'NCTW_Gas_HF_Offset_Avg'
...
plot(data['Position'],data['0.2 m'],marker=next(markers), label='0.2 m Above Burner',ms=8)
plot(data['Position'],data['0.4 m'],marker=next(markers), label='0.4 m Above Burner',ms=8)
plot(data['Position'],data['0.6 m'],marker=next(markers), label='0.6 m Above Burner',ms=8)
plot(data['Position'],data['0.8 m'],marker=next(markers), label='0.8 m Above Burner',ms=8)
plot(data['Position'],data['1.0 m'],marker=next(markers), label='1.0 m Above Burner',ms=8)
plot(data['Position'],data['1.2 m'],marker=next(markers), label='1.2 m Above Burner',ms=8)
ax1 = gca()
