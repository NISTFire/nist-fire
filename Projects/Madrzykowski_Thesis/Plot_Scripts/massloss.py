...
plot(data['Time (s)'],data2.mean(axis=1),'k',label=test_name.replace('_',' ') +' AVG',linewidth=3)
ax1 = gca()
xlabel('Time (s)', fontsize=20)
ylabel('Mass Loss (kg)', fontsize=20)
xticks(fontsize=16)
yticks(fontsize=16)
legend(numpoints=1,loc=location,ncol=1,fontsize=16)
axis([0, 300, 0, 0.4])
grid(True)
