...
\begin{minipage}[b]{0.8\columnwidth}
	...
	~(2)~ Middle burner on 				&   182			  &		181			&		178		  \\
	~(3)~ Center burner on 				&   362			  &	   	361			&	   	359		  \\
	~(4)~ West double door opened 		&   417			  &    	417			&	   	415		  \\
	~(5)~ East double door opened 		&   538			  &    	537			&	   	535		  \\
	~(6)~ South exterior door opened 	&   606			  &    	598			&	   	597		  \\
	~(7)~ Center burner off				&   720			  &    	778			&	   	778		  \\
	~(8)~ Middle burner off				&   841			  &    	898			&	   	897		  \\
	~(9)~ Corner burner off				&   962			  &    	1018		&	   	1019	  \\
	(10) PPV fan on 					& 	1254		  &    	1316		&  	   	1486	  \\	
	\bottomrule
	\end{tabular}
	\end{flushleft}
\end{minipage}
...
\begin{minipage}[b]{0.8\columnwidth}
	...
	\midrule
	~(1)~ All burners on 				& 	0			  &	   1225			&	   2426		\\
	~(2)~ Roof vent opened 				&   155			  &    1346			&	   2546		\\
	~(3)~ West double door opened 		&	176			  &	   1431	 		&	   2631 	\\
	~(4)~ East double door opened 		&   361			  &    1531			&	   2731		\\
	~(5)~ Roof vent closed		 		&   446			  &    1724			&	   2852		\\
	~(6)~ All burners off 				&   577			  &    1840			&	   2998		\\
	~(7)~ Roof vent opened				& 	722 		  &	   1887			&	   3087		\\
	~(8)~ East double door closed		& 	1149 		  &	   2311			&	   N/A		\\
	~(9)~ West double door closed		& 	1165 		  &	   2331			&	   N/A		\\
	(10) Roof vent closed		 		&   1180		  &    2388			&	   N/A		\\
	\bottomrule
	\end{tabular}
	\end{flushleft}
\end{minipage}
...
\begin{minipage}[b]{0.8\columnwidth}
	...
	\multicolumn{1}{c}{\textbf{Event}} 	& \textbf{Seq. 1}	& \textbf{Seq. 2} 	& \textbf{Seq. 3} 	\\
	\midrule
	~(1)~ All burners on 				&	0				&	566				&	1077			\\
	~(2)~ West double door opened 		&	115				&   685				&	1195			\\
	~(3)~ Roof vent opened 		    	&	208				&	748 			& 	1288 			\\
	~(4)~ All burners off 				&	327				&   868				&	1388			\\
	~(5)~ East double door opened		&	371				&   911				&	1446			\\
	~(6)~ Roof vent closed 				&	495				&   1041			&	N/A				\\
	~(7)~ East double door closed		&	524 			&	1016			&	N/A 			\\
	~(8)~  West double door closed		&	539 			&	1026			&	N/A				\\
	\bottomrule
	\end{tabular}
	\end{flushleft}
\end{minipage}
...
\begin{minipage}[b]{0.8\columnwidth}
	...
	~(2)~  2nd floor west double door opened 	&   195		  		&    133		\\
	~(3)~  1st floor west double door opened 	&	315		  		&    255 	 	\\
	~(4)~  1st floor east double door opened 	&   450			  	&    374		\\
	~(5)~  2nd floor east double door opened	&   586			  	&    501		\\
	~(6)~  PPV fan on 							&   653			  	&    614		\\
	~(7)~  PPV fan off              			&   800			  	&    764		\\
	~(8)~  All burners off 						&   830			  	&    797		\\
	~(9)~  2nd floor south exterior door opened &   899			  	&    850		\\
	(10) PPV fan on 	 						&   1066		  	&    943		\\
...
\begin{minipage}[b]{0.8\columnwidth}
	...
	\midrule
	~(1)~ All burners on 						&   0		  		&	 0			\\
	~(2)~ Interior stairwell door opened 		&   120		  		&    114		\\
	~(3)~ 1st floor west double door opened 	&	240		  		&    245 	 	\\
	~(4)~ 2nd floor west double door opened 	&   360			  	&    354		\\
	~(5)~ 2nd floor south exterior door opened	&   480			  	&    474		\\
	~(6)~ PPV fan on 							&   600			  	&    595 		\\
	~(7)~ All burners off 						&   720 		  	&    715		\\
	~(8)~ 2nd floor east double door opened 	&   855			  	&    N/A		\\
	~(9)~ 1st floor east double door opened		& 	N/A 			& 	 962		\\
	\bottomrule
	\end{tabular}
	\end{flushleft}
\end{minipage}
