...
\begin{minipage}[b]{0.8\columnwidth}
	...
	\small
	\begin{tabular}{lcc}
	\multicolumn{3}{c}{\normalsize Event Times (mm:ss) for Tests~22--23 Data Files} \\
	\toprule
	...
	(10) Center burner off 					&   22:00		  	&    17:00		\\
	(11) Middle burner off 					&   22:00		  	&    17:00		\\
	(12) Corner burner off 					&   22:00		  	&    17:00		\\
	% doors were opened, fan was on after burners turned off
	\bottomrule
	\end{tabular}
	\end{flushleft}
\end{minipage}
\begin{minipage}[b]{0.9\columnwidth}
	\vspace{15pt}
	\centering
	\includegraphics[width=0.86\columnwidth]{../Figures/Floor_Plans/West_Structure_2nd_Floor_Test_22}
	\includegraphics[width=0.86\columnwidth]{../Figures/Floor_Plans/West_Structure_1st_Floor_Test_22}
\end{minipage}
...
\begin{minipage}[b]{0.8\columnwidth}
	...
	\small
	\begin{tabular}{lcc}
	\multicolumn{3}{c}{\normalsize Event Times (mm:ss) for Tests 24--25 Data Files} \\
	\toprule
	...
	% (9) PPV fan off              				&   16:30		  	&    		\\
	(9) Center burner off 						&   15:00		  	&    14:00		\\
	(10) Middle burner off 						&   15:00		  	&    14:00		\\
	(11) Corner burner off 						&   15:00		  	&    14:00		\\
	% doors were opened, fan was on after burners turned off
	\bottomrule
	\end{tabular}
	\end{flushleft}
