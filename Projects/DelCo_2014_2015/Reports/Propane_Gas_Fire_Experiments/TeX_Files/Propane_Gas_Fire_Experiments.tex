...
The ceiling height of each structure was approximately 2.4~m (8~ft). The interior dimensions of the East Structure were approximately 6.1~m (20~ft) by 11~m (36~ft), and the interior dimensions of the first and second floors of the West Structure were 5.8~m (19~ft) by 10.7~m (35.1~ft) and 6.1~m (20~ft) by 10.9~m (35.8~ft), respectively. The stairs connecting the two floors of the West Structure started 1.6~m (5.3~ft) off the interior south wall with a width of 1.2~m (4~ft) off the interior east wall and contained a 180~mm (7.25~in) rise and 190~mm (7.5~in) run. The exterior doors of both structures, the stairwell door on the second level of the West Structure, and the square roof vent in the East Structure with a 1.2~m (4~ft) side length and 320~mm (12.75~in) depth were opened and closed at certain instances during experiments to change the ventilation patterns within the structures. 
\FloatBarrier
...
Every thermocouple array contained eight bare-bead thermocouples, each bi-directional probe and solid thermocouple array contained 8 probes, and gas concentrations were pulled through 9.5~mm (0.375~in) diameter stainless steel tubing located 1.2~m (4~ft) above the floor. Each pair of total heat flux sensors were located 1.0~m (3.3~ft) above the floor. The pair at A16 contained one sensor facing the ceiling and another facing the north side of the room, and the pair at A17 also contained one sensor facing the ceiling and another facing the stairway door.
\clearpage
...
A rotary type gas meter was used to measure the volume of propane provided to the gas burners. The manufacturer quantifies the maximum error as $\pm$2\%. The measurement was used in conjunction with the heat of combustion of propane to calculate the heat release rate of the fire. The total expanded uncertainty for the heat release rate obtained from this method was estimated to be $\pm13$\%. ***\textit{Still need to finish uncertainty estimate and include refs}*** 

% http://www.istec-corp.com/products/gas-meter-model-romet-rm-series-rotary.pdf
...
Tests~2--4 followed an identical order of events. Fig.~\ref{fig:Tests_2-4_layout} includes a floor plan schematic and table of event times corresponding to the data files for each test. During Tests~2--4, the south exterior door was not able to completely close due to an obstruction caused by the hoses used to transport propane to the burners. So, when the south door was in the ``closed'' position, a gap of approximately 133~mm (5.25~in) was present between the door and its frame. During all other experiments, however, the south exterior doorway was not used to change the ventilation pattern of the structure and thus remained closed for the entirety of the test. For these tests, the hinged door was removed and gypsum board was used to fully close the doorway.
...
Test 5 - Seq. 1		& N/A & N/A	& 725 & N/A & N/A \\
Test 5 - Seq. 2		& N/A & N/A	& 728 & N/A & N/A \\
Test 5 - Seq. 3		& N/A & N/A	& 723 & N/A & N/A \\
Test 6 - Seq. 1		& N/A & N/A	& 722 & N/A & N/A \\
Test 6 - Seq. 2		& N/A & N/A	& 721 & N/A & N/A \\
Test 6 - Seq. 3		& N/A & N/A	& 714 & N/A & N/A \\
\bottomrule
\end{tabular}
...
\begin{minipage}[b]{0.8\columnwidth}
	...
	~(8)~ Center burner off 		&   23:00		  &    44:15		&	   63:30	\\
	~(9)~ Middle burner off 		&   23:20		  &    44:30		&	   63:45	\\
	(10)  Corner burner off 		&   23:40		  &    44:45		&	   64:00	\\
	(11) Roof vent opened			& 	26:05 		  &	   45:30		&	   65:30	\\
	(12) East double door closed	& 	33:17 		  &	   52:38		&	   N/A		\\
	(13) West double door closed	& 	33:30 		  &	   52:55		&	   N/A		\\
	(14) Roof vent closed		 	&   33:45		  &    53:54		&	   N/A		\\
	\bottomrule
	\end{tabular}
	\end{flushleft}
\end{minipage}
