...
\begin{figure}[!ht]
	...
	\caption[Three propane burners.]{Three propane burners located 0.6~m (2~ft) off the south and west interior walls of the first floor provided the fire source for the experiments.}
	\label{fig:burners}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption[Bi-directional probe plus solid thermocouple arrays in East Structure.]{Bi-directional probe plus solid thermocouple array in south exterior doorway (top) and in roof vent (bottom) of the East Structure.}
...
A rotary type gas meter was used to measure the flow of propane to the gas burners. The manufacturer of the meter quantifies the maximum error as 2\%.
