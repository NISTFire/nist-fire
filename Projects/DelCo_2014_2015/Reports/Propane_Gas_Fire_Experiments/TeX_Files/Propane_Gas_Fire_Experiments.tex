...
Tests~22 and 23 followed an identical procedure to change the ventilation. Fig.~\ref{fig:west_test_22} includes a floor plan schematic and table of event times corresponding to the data files for Tests~22 and 23. Similarly, Fig.~\ref{fig:west_test_24} includes a floor plan schematic and table of event times that outline the procedure followed during Tests~24 and 25. A 533~mm (21~in) diameter PPV fan located 2.3~m (7.5~ft) away from the first level double doors was used during the tests to change the ventilation pattern within the structure. During Tests~22 and 23, the fan was aimed at the center of both double doors, and during Tests~24 and 25, the fan was aimed at the center of the west double door. 
