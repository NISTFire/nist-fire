...
\href{http://dx.doi.org/10.6028/NIST.TN.1953}{http://dx.doi.org/10.6028/NIST.TN.1953}
\endgroup
}
...
\large
\flushright{\bf National Institute of Standards and Technology Technical Note 1953 \\
Natl.~Inst.~Stand.~Technol.~Tech.~Note~1953, \pageref{LastPage} pages (February 2017) \\
CODEN: NTNOEF }
...
\hypersetup{urlcolor=black}
\href{http://dx.doi.org/10.6028/NIST.TN.1953}{\bf http://dx.doi.org/10.6028/NIST.TN.1953} \\
\endgroup
