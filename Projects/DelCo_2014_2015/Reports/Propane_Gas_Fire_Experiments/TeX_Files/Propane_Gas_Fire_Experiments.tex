...
The standard uncertainty in the temperature of the thermocouple wire itself is $\pm$2.2$~^{\circ}$C at $277~^{\circ}$C and increases to $\pm$9.5$~^{\circ}$C at $871~^{\circ}$C as determined by the wire manufacturer~\cite{Omega:2004}. The variation of the temperature in the environment surrounding the thermocouple is known to be much greater than that of the wire uncertainty~\cite{Pitts:2003}. Blevins found that the percent error in the measured upper layer temperature for a 1~mm bare-bead thermocouple is bounded by a maximum of 20~\%~\cite{Blevins:1999}. Small diameter thermocouples were used to limit the impact of radiative heating and cooling. The estimated total expanded uncertainty for temperature in these experiments is $\pm$15~\%. ***\textit{Still need to finish reviewing literature about TC uncertainty and add list of components of standard uncertainty along with description about uncertainty estimate.}*** 
