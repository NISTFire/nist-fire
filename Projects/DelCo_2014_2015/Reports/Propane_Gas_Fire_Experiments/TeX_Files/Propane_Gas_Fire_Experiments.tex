...
Natl.~Inst.~Stand.~Technol.~Tech.~Note~XXXX, \pageref{LastPage} pages (October 2016) \\
CODEN: NTNOEF }
...
A gas sampling system with relative expanded uncertainty of $\pm$1~\% when compared to span gas volume fractions~\cite{Bundy:2007} from California Analytical Instruments, Inc. (model 602P) was used to make gas concentration measurements. However, according to a study by Lock~et~al.~\cite{Lock:1}, the non-uniformity and movement of exhaust gases contribute to an estimated relative expanded uncertainty of $\pm$12~\%.
