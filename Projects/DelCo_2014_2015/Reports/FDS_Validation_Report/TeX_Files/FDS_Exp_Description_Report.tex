...
% \begin{figure}[!ht]
% 	\includegraphics[width=0.35\columnwidth]{../Figures/Floor_Plans/Legend}
% 	\caption[Instrumentation Legend.]{Instrumentation Legend.}
...
\subsubsection*{East Structure}
Three different test series -- Series 4, Series 5, and Series 6 -- were conducted in the east structure. Each series was composed of three experiments that used an identical procedure to change the ventilation pattern in the structure. The three procedures used for each test series are outlined in Figs.~\ref{fig:east_test_4}-\ref{fig:east_test_6}.
...
\end{minipage}
\caption{Test Series 4 layout and ordered sequence of events.}
...
\end{minipage}
\caption{Test Series 5 layout and ordered sequence of events.}
...
\end{minipage}
\caption{Test Series 6 layout and ordered sequence of events.}
\label{fig:east_test_6}
\end{figure}
\FloatBarrier

\subsubsection*{West Structure}
Two different test series -- Series 22 and Series 24 -- were conducted in the west structure. Each series was composed of two experiments that used an identical procedure to change the ventilation pattern in the structure. The two procedures used for each test series are outlined in Figs.~\ref{fig:west_test_22} and \ref{fig:west_test_24}.
...
\begin{minipage}[b]{0.9\columnwidth}
	\vspace{15pt}
	\centering
	% \includegraphics[width=\columnwidth]{../Figures/Floor_Plans/West_Structure_Test_22}
\end{minipage}
\caption{Test Series 22 layout and ordered sequence of events.}
...
\begin{minipage}[b]{0.9\columnwidth}
	\vspace{15pt}
	\centering
	% \includegraphics[width=\columnwidth]{../Figures/Floor_Plans/West_Structure_Test_24}
\end{minipage}
\caption{Test Series 24 layout and ordered sequence of events.}
