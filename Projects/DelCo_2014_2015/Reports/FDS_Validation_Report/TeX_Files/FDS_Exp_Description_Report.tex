...
This report describes the full-scale fire test experiments that are used for the FDS model validation of [...]. Thirteen experiments that followed five different procedures were conducted in two structures designed to replicate typical residential dwellings. During each test, propane was provided to three burners at a known flow rate [to create a diff flame]. Local measurements of temperature, gas velocity, heat flux, and gas concentrations were collected. 
