...
\small{(mph)} & (-0.7 $\pm0.1$) & & (2.1 $\pm0.4$) & (3.2 $\pm0.6$) & & (1.7 $\pm0.3$) & (1.7 $\pm0.3$) 
\\ \multicolumn{9}{c}{} \\
\multirow{2}{*}{\textit{Wide Fog}} & 
\small{m/s}   &   2.4 $\pm0.4$  & &   1.3 $\pm0.2$  & 1.4 $\pm0.2$    & &   1.2 $\pm0.2$  & 0.8 $\pm0.1$ \\ &
\small{(mph)} & (-0.7 $\pm0.1$) & & (2.8 $\pm0.5$) & (3.1 $\pm0.6$) & & (2.7 $\pm0.5$) & (1.7 $\pm0.3$) 
\\ \midrule
...
\toprule
 & \multicolumn{5}{c}{\underline{Test 6}}
\\
\textbf{Stream} & \textbf{Units} & 
...
\\ \midrule
 & \multicolumn{5}{c}{\underline{Test 7}}
\\
\textbf{Stream} & \textbf{Units} & 
\textbf{Fixed} & \textbf{Sweeping} & \textbf{Clockwise} & \begin{tabular}{@{}c@{}} \textbf{Counter} \\ \textbf{Clockwise} \\ \end{tabular}
\\ \midrule
