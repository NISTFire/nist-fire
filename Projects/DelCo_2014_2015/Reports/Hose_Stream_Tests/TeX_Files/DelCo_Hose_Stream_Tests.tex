...
\begin{figure}[!ht]
	...
	\caption[North side of the Single Story and Two Story Structures.]{North side of the Single Story (top) and Two Story (bottom) Test Structures.}
...
\label{sec:layout}
Dimensioned floor plans of the Single Story and Two Story Structures are presented in Figures~\ref{fig:east_dimensioned_plan}~and~\ref{fig:west_dimensioned_plan}, respectively.
...
The interior dimensions of each structure were approximately 6.1~m (20~ft) wide, 11~m (36~ft) long and 2.4~m (8~ft) high. The stairs connecting the two floors of the Two Story Structure started 1.6~m (5.25~ft) off the south wall with a width of 1.2~m (4~ft) off the east wall.
...
Three different structure layouts were used for the seven tests. The tests conducted in the Single Story Structure, Tests 33 and 34, were performed using an identical structure layout, presented in Fig.~\ref{fig:east_setup}. Test 33 used a monitor and combination nozzle to flow water, and Test 34 used a combination nozzle attached directly to a handline to flow water.

The main difference between the two layouts used for the Two Story Structure experiments is the position of the south side door on the first level. Tests 16 and 18 used the configuration with the door opened (Fig.~\ref{fig:flow_path_1}), and Tests 17, 19, and 70 used the configuration with the door closed (Fig.~\ref{fig:flow_path_2}). Tests 16 and 17 used a combination nozzle attached to a monitor to flow water; Tests 18 and 19 used a combination nozzle attached directly to a handline to flow water; and Test 70 used a combination nozzle and a smooth bore nozzle attached to a monitor to flow water in a straight and solid stream, respectively. 

\begin{figure}[!ht]
	\includegraphics[width=\columnwidth]{../Figures/Floor_Plans/Specific_Tests/East_Hose_Test_Annotated}
	\caption[Plan view of the Single Story Structure setup for Tests 33 and 34.]{Plan view of the Single Story Structure setup for Tests 33 and 34. The view is annotated with the approximate location of water flow (nozzle graphic), the direction of the established flow path (red line), and the approximate location of bi-directional probe array A6 (blue square).}
...
\begin{figure}[!ht]
	...
	\caption[Plan view of the Two Story Structure setup for Tests 17 and 19.]{Plan view of the second floor (top) and first floor (bottom) setup in the Two Story Structure for Tests 17 and 19. The approximate location of water flow (nozzle graphic), the direction of the established flow path (red line), and the approximate location of bi-directional probe array A10 (blue square). The stairwell door and north side, west double door on the second floor were opened and closed at certain instances during the tests; the flow path was considered fully established when both first and second floor doors were in the opened position.}
...
\begin{figure}[!ht]
	...
	\end{center}
	\endminipage
	\caption[Straight stream from combination nozzle and solid stream from smooth bore nozzle with 1~in tip during Test 70.]{Straight stream flowing from the combination nozzle (left) and solid stream flowing from the smooth bore nozzle (right) during Test 70.}
...
\\ 
\midrule
\textit{Straight} & 0.9 $\pm0.2$ & 0.9 $\pm0.2$ & 0.7 $\pm0.1$ & 0.7 $\pm0.1$ & -0.3 $\pm0.1$
\\ \multicolumn{6}{c}{} \\
\textit{Narrow Fog} & 0.9 $\pm0.2$ & 1.4 $\pm0.3$ & 0.7 $\pm0.1$ & 0.7 $\pm0.1$ & 1.0 $\pm0.2$
\\ \multicolumn{6}{c}{} \\
\textit{Wide Fog} & 1.2 $\pm0.2$ & 1.3 $\pm0.2$ & 0.9 $\pm0.2$ & 0.8 $\pm0.1$ & 2.4 $\pm0.4$
\\ \midrule
...
\\
\midrule
\textit{Straight} & 1.7 $\pm0.3$ & 1.9 $\pm0.3$ & \multicolumn{3}{c}{} 
\\ \multicolumn{6}{c}{} \\
\textit{Smooth Bore} & 1.7 $\pm0.3$ & 2.0 $\pm0.4$ & \multicolumn{3}{c}{}
\\
\bottomrule
\end{tabular}
...
Looking at the table and figures, a number of trends can be observed. For example, there was significant air movement (gas velocity greater than 0.5 m/s) through the interior doorway while the flow path was fully established for every hose stream and target location combination except the straight stream in Test 33. Also, looking at Table~\ref{table:all_mon_vel_avgs}, the narrow and wide fog streams caused higher velocities through the interior doorway when the flow path was fully established compared to the straight stream. This trend is also observed above in Fig.~\ref{fig:Test_16_BDP_A10_Avg_All} and in Figs.~\ref{fig:Test_33_BDP_A6_Avg_All}~and~\ref{fig:Test_17_BDP_A10_Avg_All} in Appendix~\ref{chap:monitor_plots}. Furthermore, the wide fog stream generally produced equal or higher air velocities compared to the narrow fog stream. Finally, the Test 70 results listed in Table~\ref{table:all_mon_vel_avgs} and plotted in Fig.~\ref{fig:Test_70_BDP_A10_Avg_All} suggest that a straight stream from a combination nozzle and a solid stream from a smooth bore nozzle produce approximately the same amount of air movement through the interior doorway.
\FloatBarrier

\section{Handline Experiments}
\label{sec:handline_results}

Fig.~\ref{fig:Test_18_BDP_A10_Avg_All} contains a plot of the average measured velocity through the interior stairwell door (A10) for the straight, narrow fog, and wide fog stream patterns being applied in a fixed position, a sweeping pattern (back and forth left-to-right), a clockwise rotation, and counterclockwise rotation during Test 18. Similar plots of the average measured velocity through the interior doorway for Tests 19 and 34 are presented in Appendix~\ref{chap:handline_plots}. Additionally, Tables~\ref{table:east_hand_A6_avgs}~and~\ref{table:west_hand_A10_avgs} list the average velocity measured by the bi-directional probe array at the interior doorway when the flow path was fully established for each hose stream and application pattern combination studied during Test 34 and Tests 18-19, respectively.
...
\\ \midrule
\textit{Straight} & 0.2 $\pm0.04$ & 0.6 $\pm0.1$ & 0.8 $\pm0.1$ & -0.1 $\pm0.02$ & 0.5 $\pm0.1$ & 0.5 $\pm0.1$
\\ \multicolumn{7}{c}{} \\
\textit{Narrow Fog} & 1.7 $\pm0.3$ & 1.8 $\pm0.3$ & 1.6 $\pm0.3$ & 0.9 $\pm0.2$ & 1.5 $\pm0.3$ & 1.6 $\pm0.3$
\\ \multicolumn{7}{c}{} \\
\textit{Wide Fog} & 1.9 $\pm0.3$ & 2.1 $\pm0.4$ & 2.2 $\pm0.4$ & 2.1 $\pm0.4$ & 2.3 $\pm0.4$ & 2.6 $\pm0.5$
\\ \bottomrule
\end{tabular}
...
\begin{table}[!ht]
\caption{Average air velocity (m/s) [$\pm18$\%] through interior doorway when flow path was fully established for Tests 18 and 19}
\begin{tabular}{lcccc}
\toprule
...
\begin{figure}[!ht]
	...
	\caption{Average velocity through stairwell door during Test 70 for straight stream and smooth bore stream patterns. \textit{Note: the increase in velocities around the 300~s mark is the result of opening and then closing the 2nd floor, west double door}}
