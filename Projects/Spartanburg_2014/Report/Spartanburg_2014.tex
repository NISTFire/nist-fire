...
\caption{Instrumentation, 305 Manning, first floor}
\label{fig:Instrumentation_305_Manning_1st_Floor}
\end{figure}

\begin{figure}[!ht]
\includegraphics[width=6in]{../Figures/Instrumentation/289_Manning_2nd_Floor}
\caption{Instrumentation, 305 Manning, second floor}
\label{fig:Instrumentation_305_Manning_2nd_Floor}
\end{figure}
