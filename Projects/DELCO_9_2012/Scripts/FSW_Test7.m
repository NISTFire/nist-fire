...
for j=1:Num_TC_arrays-2
    ...
    line([270;270],[0;1100],'Color','k','LineWidth',1)
    line([291;291],[0;1100],'Color','k','LineWidth',1)
    line([308;308],[0;1100],'Color','k','LineWidth',1)
    line([323;323],[0;1100],'Color','k','LineWidth',1)
    line([220;220],[0;1100],'Color','k','LineWidth',1)
    text(220,1180,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(274,1180,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(295,1180,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(312,1180,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(327,1180,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    xlabel('Time (s)')
...
for j=1:Num_TC_arrays-2
    ...
    line([220;220],[0;1100],'Color','k','LineWidth',1)
    text(220,1180,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(270,1180,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(291,1180,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(308,1180,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(323,1180,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    xlabel('Time (s)')
    ylabel('Temperature ( \circ C)')
    axis([200 350 0 1000])
    legend(TC_array(j,:),'Location','NorthEastOutside')
...
line([323;323],[0;1100],'Color','k','LineWidth',1)
line([220;220],[0;1100],'Color','k','LineWidth',1)
text(220,120,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(270,120,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(291,120,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(308,120,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
text(323,120,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
...
plot(exp_data_reduced(:,1),velocity_reduced(:,7),'-d','Color',brown)
    line([270;270],[-5;5],'Color','k','LineWidth',1)
    line([291;291],[-5;5],'Color','k','LineWidth',1)
    line([308;308],[-5;5],'Color','k','LineWidth',1)
    line([323;323],[-5;5],'Color','k','LineWidth',1)
    line([220;220],[-5;5],'Color','k','LineWidth',1)
    text(220,7,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(270,7,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(291,7,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(308,7,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(323,7,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 350 -5 5])
...
plot(exp_data_reduced(:,1),velocity_reduced(:,14),'-d','Color',brown)
    line([270;270],[-10;10],'Color','k','LineWidth',1)
    line([291;291],[-10;10],'Color','k','LineWidth',1)
    line([308;308],[-10;10],'Color','k','LineWidth',1)
    line([323;323],[-10;10],'Color','k','LineWidth',1)
    line([220;220],[-10;10],'Color','k','LineWidth',1)
    text(220,13,{'Window Vented'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(270,13,{'Hallway Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(291,13,{'Hallway Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(308,13,{'Room Nozzle On'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
    text(323,13,{'Room Nozzle Off'},'VerticalAlignment','top','HorizontalAlignment','center','FontSize',10,'Rotation',60)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 350 -5 10])
