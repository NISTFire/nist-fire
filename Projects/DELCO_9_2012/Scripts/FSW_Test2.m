...
exp_data_read = importdata([datadir,'FSW_Test_2_ 092812.csv']); % reads in file into text and data structure
...
for j=1:Num_TC_arrays-2
    ...
    line([235;235],[0;1100],'Color','k','LineWidth',2)
    line([250;250],[0;1100],'Color','k','LineWidth',2)
    line([272;272],[0;1100],'Color','k','LineWidth',2)
    line([287;287],[0;1100],'Color','k','LineWidth',2)
...
line([235;235],[-5;1100],'Color','k','LineWidth',2)
line([250;250],[-5;1100],'Color','k','LineWidth',2)
line([272;272],[-5;1100],'Color','k','LineWidth',2)
line([287;287],[-5;1100],'Color','k','LineWidth',2)
xlabel('Time (s)')
ylabel('Velocity (m/s)')
axis([200 350 -5 5])
