...
# Location of files
data_dir = '../Experimental_Data_Radios/'
plot_dir = '../Figures/Radios/'
info_file = '../Experimental_Data_Radios/Description_of_Experiments.csv'
...
for f in os.listdir(data_dir):
	if f.endswith('.csv'):
		...
		fig = figure()
		plot(data['Time'],data['TC17'],'b*-',markevery=50,ms=8,label='Top of Cord Coil')
		plot(data['Time'],data['TC16'],'rs-',markevery=50,ms=8,label='Top of Cord')
		plot(data['Time'],data['TC18'],'g^-',markevery=50,ms=8,label='Front of RSM')
		plot(data['Time'],data['TC19'],'co-',markevery=50,ms=8,label='PTT Button')
		plot(data['Time'],data['TC20'],'m<-',markevery=50,ms=8,label='Top of RSM')
		plot(data['Time'],data['TC21'],'k8-',markevery=50,ms=8,label='Middle of Cord Coil')
		ax1 = gca()
		...
		axis([0, end_of_test - start_of_test, 0, 260])
		grid(True)
