...
\begin{enumerate}
\item To examine with physics-based calculations the effect of flow path on the temperature, pressure,Back and fire conditions in this multi-story residential structure.
...
\multirow{2}{*}{17:16:00} & \multirow{2}{*}{}   &  \multirow{2}{*}{\parbox{10cm} {Dispatch for a ``Still'' alarm $-$ two engine companies, two truck companies, and a battalion chief.}} \\
         ...
         & & \\[0.25cm]
\multirow{2}{*}{17:20:00} & \multirow{2}{*}{0:40}  & \multirow{2}{*}{\parbox{10cm} {Attic self ventilation - heavy smoke out of front attic window and heavy smoke and fire out of rear. Rear porch ignites in model.}} \\
         & & \\[.25cm] 
