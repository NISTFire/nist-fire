...
\begin{figure}[h!]
\includegraphics[width=.8\textwidth]{../Figures/west_50th_baseline_129}
\input{../Scripts/colorbar_metric} 
\caption{Temperature 1 second prior to rear door opening.}
\label{fig:temp_129s}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=.8\textwidth]{../Figures/west_50th_baseline_159}
\input{../Scripts/colorbar_metric} 
\caption{Temperature 1 second prior to interior door failing.}
\label{fig:temp_159s}
\end{figure}


\begin{figure}[h!]
\includegraphics[width=.8\textwidth]{../Figures/west_50th_baseline_161}
\input{../Scripts/colorbar_metric} 
\caption{Temperature 1 second after interior door fails.}
\label{fig:temp_161s}
\end{figure}
...
\input{../Scripts/colorbar_metric}
\caption{Temperature 15 seconds after interior door fails.}
\label{fig:temp_175s}
\end{figure}
