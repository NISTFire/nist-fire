...
\section{Temperature}
For analysis of the predicted simulation temperatures, the analysis will focus on the high hazard areas of the structure: the attic, the rear porch and connecting stairwell, and the interior hallway which connects the rear porch to the front stairwell. Here, we will examine the temperature profile through these high hazards area at several snapshots in time to illustrate how several key events correspond to changing interior conditions. The first time to consider is just before a firefighter opened the rear porch door (cf. Fig.~(\ref{fig:temp_129s})).
