...
\begin{table}
\centering
\captionof{table}{Abridged NIOSH approximate fire event timeline}\label{tab:fire_info}
\begin{tabular}{cl}
\toprule[1.5pt]
...
\multirow{2}{*}{17:16:00} & \multirow{2}{*}{}   &  \multirow{2}{*}{\parbox{9cm} {Dispatch for a ``Still'' alarm - two engine companies, two truck companies, and a battalion chief.}} \\
         & & \\[.25cm]
\multirow{3}{*} {} &  \multirow{3}{*} {0} &  \multirow{3}{*}{\parbox{8cm} {Simulation starts. Attic fire ignites. Initial ventilation through rear of structure. Front door open.}} \\
         & & \\[0.25cm]
         & & \\[0.25cm]
