...
17:16 &      & Dispatch for a Still Alarm. \\ [0.25cm]
         &  \multirow{2}{*} {0:00} &  \multirow{2}{*}{\parbox{10cm} {Simulation starts. Attic fire ignites. Initial self ventilation on charlie side. Front door open.}} \\
         & & \\[0.25cm]
\multirow{2}{*}{17:20} & \multirow{2}{*}{0:40}  & \multirow{2}{*}{\parbox{10cm} {Attic self ventilation - heavy smoke out of front attic window and heavy smoke and fire out of rear. Rear porch ignites in model.}} \\
         & & \\[.25cm] 
...
\multirow{2}{*}{17:23}    & \multirow{2}{*}{3:40} & \multirow{2}{*}{\parbox{10cm} {Heavy fire report in rear stairwell and enclosed porch. No response from E123: Capt. or FF.}} \\
         & & \\[.25cm]
17:24    &   & Water applied to attic from the rear exterior position. \\[.25cm]
...
While we have an estimated time of failure for the door, the key take away is that after the door failed an interior flow path from the Charlie side to the Alpha side of the structure was created. This resulted in a rapid change in the conditions within the flow path. The combustion gases at elevated temperature and pressure flowed toward ambient conditions; the flow path was through the interior hallway, kitchen, and down the Alpha-Delta stairwell and out of the structure through the front door. The arrows in Fig.~(\ref{fig:flowpath_1}) show the flow direction of gases  on the second flow following the door failure.
...
Prior to door failure, the elevated temperatures on the second floor were limited to the rear porch, Fig.~(\ref{fig:temp_top_159}). Temperatures are highest at the Beta-Charlie corner where there is sufficient oxygen due to self-ventilation. Five seconds after the door fails, hot gases have traveled the length of the interior hallway and approached the doorway into the kitchen, approximately 4.5 m (14.8 ft) away from the source fire (cf Fig.~(\ref{fig:temp_top_165})). One minute after the door fails, the hallway temperatures are nominally at or above 260 $^{\circ}$C (500 $^{\circ}$F) through out the hallways corridor (cf Fig.~(\ref{fig:temp_top_220})). This illustrates the the high temperature gases seen five seconds after failure were not just a burst but rather the front of a sustained exhaust gas flow from the fire burning on the rear porch. The conditions in this hallway changed from tenable to high-hazard very rapidly following the door failure. Fig.~(\ref{fig:temp_top_220}) also shows that that temperatures in the kitchen dropped below 100 $^{\circ}$C (212 $^{\circ}$F) as the large supply of air cooled/diluted the exhaust gases. Based on post-incident images of the kitchen and second floor stairwell, these predicted temperatures are realistic.

\begin{figure}[h!]
\centering
\includegraphics[width=.7\textwidth]{../Figures/west_50th_baseline_top_159}
\caption{PLACEHOLDER: Temperature contours on the second floor, 1 second prior to door failure, 6ft above the floor.}
\label{fig:temp_top_159}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=.7\textwidth]{../Figures/west_50th_baseline_top_165}
\caption{PLACEHOLDER: Temperature contour on the second floor, 5 seconds after door failure, 6ft above the floor.}
\label{fig:temp_top_165}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=.7\textwidth]{../Figures/west_50th_baseline_top_200}
\caption{PLACEHOLDER: Temperature contour on the second floor, 60 seconds after door failure, 6ft above the floor.}
\label{fig:temp_top_220}
\end{figure}


\section{Tactical Considerations}
In the last fifteen years, there have been fires throughout the country where the change in a flow path has had a significant impact on firefighter and occupant safety:

{\bf UNDER DEVELOPMENT}

\begin{itemize}
\item NE Washington D.C., 1999
\item Keokuk, IA, 1999
\item Houston, TX, 2011
\item Riverdale Heights, MD, 2012 
\end{itemize}
