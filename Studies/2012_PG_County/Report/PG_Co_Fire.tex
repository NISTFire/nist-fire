...
In addition to the state of openings within the structure, outlined in Table~\ref{tab:vents}, an 8.9~m/s (20~mph) wind velocity boundary condition was assumed. The flow direction of the wind was from the rear toward the front of the structure, perpendicular to the rear of the structure.  Based on local weather conditions, mean wind velocities ranged between 4.5~m/s (10~mph) and 8.9~m/s (20~mph) with gusts up to 13.4~m/s (30~mph) with a direction that angled toward the back left of the structure~\cite{PGCounty2013}.
...
\input{../Scripts/colorbar_metric_velo}
\input{../Scripts/colorbar_std_velo}
\caption[Calculated velocity on the first floor 1~s before and after front door opens]
...
\caption[Calculated temperature on the first floor 1~s before front door opened.]
...
\input{../Scripts/colorbar_metric_temp}
\input{../Scripts/colorbar_std_temp}
\caption[Calculated temperature on the first floor 1~s after front door opens.]
...
\input{../Scripts/colorbar_std_temp} \\
\end{subfigure}
\caption {Interior temperature contours 1~s before the front door was opened. The top snapshot shows temperatures on the first floor and basement on a plane that runs through the center of the front door. The bottom snapshot shows temperatures on the first floor and basement on the plane that runs through the center of the interior stairwell doorway.}
...
\input{../Scripts/colorbar_std_temp} \\
\end{subfigure}
\caption{Interior temperature contours 1~s after the front door was opened. The top snapshot shows temperatures on the first floor and basement on a plane that runs through the center of the front door. The bottom snapshot shows temperatures on the first floor and basement on the plane that runs through the center of the interior stairwell doorway.}
...
\input{../Scripts/colorbar_std_temp} \\
\end{subfigure}
\caption{Interior temperature contours as firefighters made entry to the structure. The top snapshot shows temperatures on the first floor and basement on a plane that runs through the center of the front door. The bottom snapshot shows temperatures on the first floor and basement on the plane that runs through the center of the interior stairwell doorway.}
