...
plt.plot(C_FDS['Time'],HRR_avg,'r-',mfc='none',label='FDS Model HRR w/ Rear Door',linewidth=2)
plt.plot(ND_FDS['Time'],HRR_ND_avg,'g--',mfc='none',label='FDS Model HRR w/o Rear Door',linewidth=2)
