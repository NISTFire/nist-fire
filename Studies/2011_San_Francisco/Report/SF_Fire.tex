...
% \begin{figure}[!ht]
% \includegraphics[width=in]{../Figures/1st_Floor_Metric} \\
% \includegraphics[width=in]{../Figures/2nd_Floor_Metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=.80in]{../Figures/door_frame_burn}
...
% \begin{figure}[!ht]
% \includegraphics[width=.49in]{../Figures/smv_exterior_grid} \\
% \includegraphics[width=.488in]{../Figures/smv_exterior_grid_rear}
% \caption{Front (left) and rear (right) of the structure with 10~cm computational mesh.}
% \label{fig:geom_grid}
% \end{figure}

% \begin{figure}[!ht]
% \includegraphics[width=.60in]{../Figures/smv_exterior_mesh}
...
Grid Cell Size                                             &  10~cm                                        & Section~\ref{sec:numerical_mesh}               \\ [.25cm]
Ambient Temperature$^*$                                    &  20~$^{\circ}$C (77~$^{\circ}$F)              & --                                             \\ [.1cm]
\multirow{4}{*}{Reaction: Wood~\cite{SFPE:Tewarson}}       &  Formula: $\C\H_{1.7}\O_{0.74}\N_{0.002}$     & \multirow{4}{*}{Section~\ref{sec:fire}}        \\
                                                           &  CO Yield: 0.004~$\mathrm{kg}/\mathrm{kg}$    &                                                \\
                                                           &  Soot Yield: 0.015~$\mathrm{kg}/\mathrm{kg}$  &                                                \\
                                                           &  Heat of Combustion: 16,400~kJ/kg             &                                                \\ [.25cm]
\multirow{2}{*}{Peak HRR}                                  &  Attic Fire: 9~MW                             & \multirow{2}{*}{Section~\ref{sec:fire}}        \\ 
                                                           &  Porch Fire: 3.3~MW                           &                                                \\ [.25cm]                     
\multirow{3}{*}{Material: Wood~\cite{Incropera:1} }        &  $k$: 0.12~\si{W/(m.K)})                      & \multirow{3}{*}{Section~\ref{sec:materials}}   \\
                                                           &  $\rho$: 510~kg/m$^3$                         &                                                \\
                                                           &  $c_{p}$: 1.38~\si{kJ/(kg.K)}                 &                                                \\ [.25cm]
\multirow{3}{*}{Material: Gypsum Board~\cite{WAKILI2007}}  &  $k$: 0.28~\si{W/(m.K)}                       &  \multirow{3}{*}{Section~\ref{sec:materials}}  \\ 
                                                           &  $\rho$: 810~kg/m$^3$                         &                                                \\ 
                                                           &  $c_{p}$: 1.0~\si{kJ/(kg.K)}                  &                                                \\
\bottomrule
\end{tabular}
...
% \begin{figure}[!ht]
% \includegraphics[width=.80in]{../Figures/Chicago_Fire_HRR}
...
% \begin{figure}[!ht]
% \includegraphics[width=.675in]{../Figures/smv_exterior_fire}
...
% \begin{figure}[!ht]
% \includegraphics[width=.75in]{../Figures/west_50th_baseline_pres2}
...
% \begin{landscape}
% \begin{figure}[!ht]
% \includegraphics[width=1.1in]{../Figures/west_50th_baseline_velo_175}
...
% \begin{figure}[!ht]
% \includegraphics[width=.675in]{../Figures/west_50th_baseline_129}
...
% \begin{figure}[!ht]
% \includegraphics[width=.675in]{../Figures/west_50th_baseline_159}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=.675in]{../Figures/west_50th_baseline_161}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=.675in]{../Figures/west_50th_baseline_175}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=.4in]{../Figures/Porch_Door_1}
...
% \begin{figure}[!ht]
% \includegraphics[width=.7in]{../Figures/ChicagoFlow}
...
% \begin{figure}[!ht]
% \includegraphics[width=.68in]{../Figures/west_50th_baseline_top_159_6ft}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=.68in]{../Figures/west_50th_baseline_top_165_6ft}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=.68in]{../Figures/west_50th_baseline_top_220_6ft}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=1in]{../Figures/50th_Place_1st_Floor}
...
% \begin{figure}[!ht]
% \includegraphics[width=1in]{../Figures/50th_Place_2nd_Floor}
