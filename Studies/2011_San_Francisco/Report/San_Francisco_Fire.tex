...
\caption{Summary of simulated flow path in the stairwell on the first floor and basement floor 120~s after the first rear basement window failure. The arrows indicate the direction of flow. Two arrows located at a door or window indicate bi-directional flow at a vent opening. The maximum velocity is indicated by the red contour and corresponds to 9~m/s (20~mph).}
...
\input{../Figures/colorbar_metric_temp}
\input{../Figures/colorbar_std_temp}
\caption{Top view of simulated temperature contours on the first floor, 1.2~m from the floor (mid-level height), 2~s before the first rear basement window failure (342~s).}
...
\input{../Figures/colorbar_metric_temp}
\input{../Figures/colorbar_std_temp}
\caption{Top view of simulated temperature contours on the first floor, 1.2~m from the floor (mid-level height), 60~s (top) and 120~s (bottom) after the first rear basement window failure (342~s).}
