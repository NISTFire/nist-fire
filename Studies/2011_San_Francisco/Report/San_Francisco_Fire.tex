...
\begin{tabular}{ccll}
\toprule
FDS Simulation  &  Ventilation  &  Type                &  Location of Vent        \\
Time            &  Area         &                      &                          \\
{(s)}           &  (m$^2$)      &                      &                          \\
\midrule
0               &  1.47         &  Door                &  Front Exterior          \\
0               &  1.68         &  Door                &  Interior (Stairwell)    \\
0               &  1.68         &  Door                &  Interior (Garage)       \\
0               &  10.1         &  Overhead Door       &  Front Exterior          \\
N/A$^*$         &  1.68         &  Door                &  Left Basement Exterior  \\
...
\end{tabular}
\footnotesize
\\$^*$This ventilation event was not included in the simulation.
\normalsize
