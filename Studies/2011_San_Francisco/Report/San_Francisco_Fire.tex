...
{Simulated pressure contours on the right interior side of the structure, 2~s before (top) and 1~s after (bottom) first rear basement window failure (342~s). The fire originated in the living room in the basement.}
...
{Simulated velocity contours on the right interior side of the structure, 2~s before (top) and 60~s after (bottom) first rear basement window failure (342~s).}
...
{Simulated velocity vectors on the right interior side of the structure, 2~s before (top) and 60~s after (bottom) first rear basement window failure (342~s).}
...
{Simulated temperature contours on the right interior side of the structure, 2~s before (top) and 60~s after (bottom) first rear basement window failure (342~s).}
...
{Simulated temperature vectors on the right interior side of the structure, 2~s before (top) and 60~s after (bottom) first rear basement window failure (342~s).}
...
{Top view of the simulated flow path on the first floor and basement floor 120~s after the first rear basement window failure. The arrows indicate the direction of flow. Two arrows located at a door or window indicate bi-directional flow at a vent opening. The maximum velocity is indicated by the red contour and corresponds to 9~m/s (20~mph).}
...
{Top view of simulated temperature contours on the first floor, 1.2~m from the floor (mid-level height), 2~s before the first rear basement window failure (342~s).}
...
{Top view of simulated temperature contours on the first floor, 1.2~m from the floor (mid-level height), 60~s (top) and 120~s (bottom) after the first rear basement window failure (342~s).}
