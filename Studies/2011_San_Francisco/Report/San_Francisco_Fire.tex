...
\begin{table}[!ht]
\caption[Abridged NIOSH approximate fire event timeline]{Abridged NIOSH approximate fire event timeline~\cite{NIOSH:Bowyer}}
\begin{tabular}{cl}
\toprule
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/1st_Floor_Metric} \\
% \includegraphics[width=5in]{../Figures/2nd_Floor_Metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/exterior_alpha} \\
% \includegraphics[width=5in]{../Figures/exterior_charlie}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/door_frame_burn}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/smv_exterior_grid} \\
% \includegraphics[width=5in]{../Figures/smv_exterior_grid_rear}
% \caption{Front (left) and rear (right) of the structure with 10~cm computational mesh.}
% \label{fig:geom_grid}
% \end{figure}

% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/smv_exterior_mesh}
...
To examine the results of the simulations, it is important to link the timelines from the fire scene to the simulation times. Table~\ref{tab:combined_timeline} shows the fireground timeline~\cite{NIOSH:Bowyer} along with the corresponding simulation times.
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/Chicago_Fire_HRR}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/smv_exterior_fire}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_pres2}
...
% \begin{landscape}
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_velo_175}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_129}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_159}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_161}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_175}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/Porch_Door_1}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/SC_Door_1} \\
% \includegraphics[width=5in]{../Figures/SC_Door_2}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/ChicagoFlow}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_top_159_6ft}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_top_165_6ft}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/west_50th_baseline_top_220_6ft}
% \input{../Scripts/colorbar_std} 
% \input{../Scripts/colorbar_metric}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/50th_Place_1st_Floor}
...
% \begin{figure}[!ht]
% \includegraphics[width=5in]{../Figures/50th_Place_2nd_Floor}
