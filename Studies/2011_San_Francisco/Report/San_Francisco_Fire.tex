...
\caption[Predicted HRR vs. time from the simulation.]
{Comparison of prescribed and predicted HRRs from the simulation. The vertical line indicates the time at which the rear basement windows began to fail (342~s).}
\label{fig:hrr_w_fds}
\end{figure}
...
{Simulated temperature contours in the garage, 2~s before (top) and 10~s after (bottom) the first rear basement window failure.}
