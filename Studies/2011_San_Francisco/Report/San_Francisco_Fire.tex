...
\noindent Table~\ref{tab:incident_timeline} shows an overview of the timeline of events. A plan view of the structure, the location where the downed firefighters were located, and more details of the fire development are provided in the following section.
...
\caption[Plan view of second floor (top), first floor (middle), and basement floor (bottom) of structure.]{Plan view of second floor (top), first floor (middle), and basement floor (bottom) of structure. Stairs and rooms are identified using measurements collected by NIST.}
...
% The first 300~s of the HRR in the simulation follow the mattress HRR. After 300~s, the specified fire size is 20~MW.
