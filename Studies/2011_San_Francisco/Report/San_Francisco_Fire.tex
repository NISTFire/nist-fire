...
{Top view of the simulated flow path on the first floor and basement floor 120~s after the first rear basement window failure. The arrows indicate the direction of flow. Two arrows located at a door or window indicate bi-directional flow at a vent opening. The dashed arrow indicates a continuation of flow from the basement towards the first floor. The maximum velocity is indicated by the red contour regions and corresponds to 9~m/s (20~mph).}
