...
The structure involved in this fire incident was a four-story residential building with a flat roof that consisted of a bitumen membrane. The exterior was primarily stucco with large windows on the top three stories of the rear side of the structure. The structure had exterior dimensions of 8.53~m (28~ft) by 17.73~m (58~ft) and a height of 5.9~m (19~ft) above street level, as shown in Fig.~\ref{fig:floor_plan}. The right side of the structure shared a common fire wall with another residential structure.
