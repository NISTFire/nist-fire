...
As the simulated fire grows in the basement, the pressure in the basement rises and casues the hot gases to flow upwards from a region of high pressure (basement) to low pressure. Figure~\ref{fig:smv_pressure} shows the calculated pressure conditions in the structure just before and after the rear basement window failed in the simulation (342~s). The pressure rise in the basement ranges from a 5~Pa ($7.3 \times 10^{-4}$~psi) over-pressure at mid-level height to greater than 10~Pa ($1.5 \times 10^{-3}$~psi) at the ceiling. Gases at an elevated pressure will flow towards a region of lower pressure. Once the rear basement window fails, the high pressure gases flow towards the low pressure regions in the house towards the garage and front door via the stairwell.
...
\input{../Figures/colorbar_metric_pres}
\caption{FDS simulated pressure contours, 2~s prior (top) and 1~s after (bottom) first rear basement window failure. The fire originated in the living room in the basement.}
...
The velocity vectors shown in Fig.~\ref{fig:smv_velocity_vector} (15~s after the interior door fails) indicate the direction of flow within the structure.
...
\input{../Figures/colorbar_metric_velo}
\input{../Figures/colorbar_std_velo}
\caption{FDS simulated velocity contours, 2~s prior (top) and 60~s after (bottom) first rear basement window failure.}
...
\input{../Figures/colorbar_metric_velo}
\input{../Figures/colorbar_std_velo}
\caption{FDS simulated velocity vectors, 2~s prior (top) and 60~s after (bottom) first rear basement window failure.}
\label{fig:smv_velocity_vector}
\end{figure}
...
\input{../Figures/colorbar_metric_temp}
\input{../Figures/colorbar_std_temp}
\caption{FDS simulated temperature contours, 2~s prior (top) and 60~s after (bottom) first rear basement window failure.}
...
\input{../Figures/colorbar_metric_temp}
\input{../Figures/colorbar_std_temp}
\caption{FDS simulated temperature vectors, 2~s prior (top) and 60~s after (bottom) first rear basement window failure.}
\label{fig:smv_temperature_vector}
\end{figure}
