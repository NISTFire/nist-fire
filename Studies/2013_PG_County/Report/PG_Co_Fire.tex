...
To calculate the total fire size, the appropriate burning area of the basement needed to be determined. Based on the floor plan of the structure and post-incident images, two distinct fires were considered: 1 source in the basement bathroom and 1 source in the basement kitchen. The bathroom fire was estimated to be comprised of wood paneling along the four walls (17.3~m$^2$ or 186~ft$^2$) and wood subfloors and studs along the ceiling (2.9~m$^2$ or 31~ft$^2$). This results in 20.2~m$^2$ (217~ft$^2$) of wood burning surface area at 50~kW/m$^2$ or a 1~MW energy release rate. 

The remainder of the combustable load in the basement was lumped into the localized kitchen fire.
