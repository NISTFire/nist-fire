...
{Calculated pressure contours on first floor of the structure 1~s prior to (top) and 1~s after (bottom) firefighter entry through front door.}
...
Analysis of the temperatures from the simulation focuses on the high-hazard area of the structure: the first floor area between the front door and the top of the interior stairwell. The temperature contours shown in Fig.~\ref{fig:temperature_slices} indicate the gas temperatures within the structure before and after the front door was opened.
...
\input{../Scripts/colorbar_metric_temp}
\input{../Scripts/colorbar_std_temp}
\caption[Calculated temperature on first floor 1~s before and after front door opens]
{Calculated velocity contours on first floor of the structure 1~s prior to (top) and 1~s after (bottom) firefighter entry through front door.}
