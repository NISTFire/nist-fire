...
\caption[Photograph of terrain.]{Photograph taken from front side street level showing the slope down to basement on the rear side of the structure (left) and Smokeview rendering of model representation of sloped landscape (right).}
\label{fig:slope}
\end{figure}
